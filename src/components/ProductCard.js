...
const ProductCard = ({ product }) => {
  return (
    <div className="product-card relative w-[160px] h-[240px] border border-gray-200 rounded-xl overflow-hidden bg-white shadow-lg transition-transform duration-200 hover:-translate-y-1 m-2 flex-shrink-0  max-[700px]:m-0.5 max-[545px]:w-[150px] max-[391px]:w-[45%] max-[391px]:m-[1%]">
      <div className="image-container relative w-full h-[140px] max-[391px]:h-[120px] overflow-hidden rounded-xl border-b border-gray-100">
        ...
        <button className="add-btn absolute bottom-2 right-2 w-8 h-8 max-[391px]:w-7 max-[391px]:h-7 bg-green-400 text-white border-none rounded-full text-lg max-[391px]:text-base cursor-pointer hover:bg-green-600 transition-colors duration-200">+</button>
      </div>
