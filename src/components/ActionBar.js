...
const ActionBar = () => {
  ...
  return (
    <div className="action-bar flex gap-3 bg-white items-center justify-center mt-3 mb-1">
      <button className='flex items-center gap-1 bg-gray-200 px-4 py-2 rounded-full font-semibold text-sm shadow-none' onClick={toggleCalendar}>
        <FaCalendarAlt className="calendar-icon" /> Order for Later
      </button>
      <button className='bg-gray-200 px-4 py-2 rounded-full font-semibold text-sm shadow-none'>🔗 Share</button>
